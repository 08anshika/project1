  ...
  <div className="responsive-container-block big-container">
    <div className="responsive-container-block container">
      <div className="responsive-cell-block wk-mobile-12 wk-desk-5 wk-tab-10 wk-ipadp-5" id="ih6s">
        ...
        <b>Don’t be confused about your career, Talk with an Education Advisor.</b>
        </p>
        
        <lottie-player src="https://lottie.host/2e3f0c9a-f63c-40dc-b54b-56006cfbf0b2/KeTgmZ2Jp0.json" background="transparent" speed="1" style={{width: 500, height: 500}} loop  autoplay direction="1" mode="normal"></lottie-player>
      ...
      <div className="responsive-cell-block wk-ipadp-6 wk-mobile-12 wk-desk-5 wk-tab-9" id="i6df">
        <div className="form-wrapper">
          ...
          <textarea className="textinput input-element" placeholder="Message" defaultValue={""} />
